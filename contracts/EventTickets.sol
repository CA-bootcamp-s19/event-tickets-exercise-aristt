...
contract EventTickets {
    ...
    */
    ...
    event LogBuyTickets (address purchaser, uint quantity);
    event LogGetRefund (address requester, uint quantity);
    ...
    */
    ...
    constructor (string memory _description, string memory url, uint ticketQuantity) public {
      owner = msg.sender;
      myEvent.description = _description;
      myEvent.website = url;
      myEvent.totalTickets = ticketQuantity;
      myEvent.isOpen = true;
      myEvent.sales = 0;
    }
    ...
    */
    ...
    function getBuyerTicketCount(address addr) public view returns (uint) {
    ...
    */
    function buyTickets (uint quantity) public payable {
      uint cost = quantity * TICKET_PRICE;
      require (myEvent.isOpen, "require myEvent.isOpen");
      require (msg.value >= cost, "require msg.value >= quantity * TICKET_PRICE");
      require (quantity <= myEvent.totalTickets - myEvent.sales, "quantity <= myEvent.totalTickets - totalTickets.sales");
